...
func (c *rendererServiceClient) Render(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[RenderRequest, RenderResponse], error) {
...
type RendererService_RenderClient = grpc.BidiStreamingClient[RenderRequest, RenderResponse]
...
func (UnimplementedRendererServiceServer) Render(grpc.BidiStreamingServer[RenderRequest, RenderResponse]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type RendererService_RenderServer = grpc.BidiStreamingServer[RenderRequest, RenderResponse]
